          ...
          <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto gap-12">
            <div className="lg:w-1/2 text-center lg:text-left space-y-8">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-white">
                Master any
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-400 block sm:inline">
                  {" "}
                  subject
                </span>
              ...
              <p className="text-lg sm:text-xl text-orange-100 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                ...
                categories. Learn, compete, and track your progress with our
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                ...
                <Link
                  href="/login"
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl border-2 border-orange-300/30 bg-white/10 backdrop-blur-sm font-semibold hover:bg-white/20 transition-all duration-300 text-orange-100 hover:border-orange-300/50 hover:scale-105"
                >
                  Login
                </Link>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="text-center lg:text-left">
                    ...
                    <p className="text-lg sm:text-xl text-orange-200 mb-8 leading-relaxed">
                      ...
                      knowledge through our interactive quiz platform.
                    </p>
                    ...
                    <Link
                      href="/register"
                      className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold text-lg flex items-center justify-center gap-3 hover:shadow-xl hover:shadow-orange-500/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1"
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        {sampleQuestions.slice(0, 3).map((q, i) => (
                          ...
                          >
                            ...
                            <span className="text-xs text-yellow-400 font-semibold px-2 py-1 bg-yellow-500/20 rounded-full">
                              {q.difficulty}
                            </span>
                          </div>
                        ))}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl opacity-90 mb-10 leading-relaxed">
              Discover what you know and learn what you don't. Start your first
              quiz now!
            </p>
            <Link
              href="/register"
              className="px-10 py-5 rounded-2xl bg-white/95 backdrop-blur-sm text-orange-600 font-bold text-lg hover:shadow-2xl hover:shadow-orange-700/40 transition-all duration-300 hover:bg-white hover:scale-105 hover:-translate-y-1"
            >
      ...
      <footer className="bg-gradient-to-r from-orange-900 to-yellow-900 text-orange-100 py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mb-8 text-lg text-orange-200">
              Challenge your mind, expand your knowledge
            </p>
            <div className="flex flex-wrap items-center justify-center gap-8 mb-8">
              {["About", "Categories", "Leaderboard", "Support"].map(
                (item, i) => (
                  <a
                    key={i}
                    href="#"
                    className="hover:text-white transition-colors text-orange-200 font-medium text-lg hover:scale-105 transition-transform duration-200"
                  >
                    {item}
                  </a>
                )
            ...
            <p className="text-orange-300">
              © {new Date().getFullYear()} ZapQuiz. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
