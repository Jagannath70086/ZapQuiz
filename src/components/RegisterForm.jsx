    ...
    <button
      ...
      className={`w-full py-3 px-4 rounded-xl bg-gradient-to-r from-yellow-500 to-orange-500 ${
        pending
          ...
          : "cursor-pointer hover:from-yellow-400 hover:to-orange-400"
          ...
          <div className="space-y-5">
                      ...
                      >
                        <CheckIcon
                          className={`h-3 w-3 transition-colors duration-200 ${
                            isValid ? "text-green-300" : "text-orange-400"
                          }`}
                        />
                      </div>
                      <span
                        className={`transition-colors duration-200 ${
                          isValid ? "text-green-300" : "text-orange-300"
                        }`}
                      >
                        {req.label}
                      </span>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="text-orange-200">
                  I agree to the{" "}
                  <Link
                    href="/terms"
            ...
            {errors.terms && (
              <p id="terms-error" className="mt-1 text-sm text-red-300">
                {errors.terms[0]}
              </p>
            )}
